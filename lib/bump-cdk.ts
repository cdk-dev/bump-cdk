...
async function processDependencies(dependencies: GenericObject, version: string, debug=false) {
    if (debug) {
...
export async function bumpCdk(cwd: string, version?: string, dryRun=false, debug=false): Promise<void> {
    if (debug) {
